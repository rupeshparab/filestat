...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options) {
            ...
            self.$shareContainer = getElement(options, null,
                self.$previewContainer.find('.kv-fileinput-share'));
        ...
        _showShareLink: function (msg) {
            var self = this, $share = self.$shareContainer,
            e = '<p>'+msg+'</p>';
            $share.html('');
        ...
        _resetSuccess: function (fade) {
            var self = this, $share = self.$shareContainer;
            self.$container.removeClass('alert alert-success');
            $share.html('');
            if (fade) {
                $share.fadeOut('slow');
            } else {
        ...
        _initUploadSuccess: function (out, $thumb, allFiles) {
            ...
            self._showShareLink(out.message);
